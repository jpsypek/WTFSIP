...
kari_school_2 = ParkingEvent.create(day: "Friday", user: kari, destination: flatiron, parking_location: platte_20_n, ease_rating: 5, safety_rating: 4, time_spent: 8, walkability_rating: 5, notes: "Wish I got this spot every fucking day when heading to class.")
...
ParkingEvent.create(day: "Tuesday", user: kari, destination: joyride, parking_location: platte_20_n, ease_rating: 1, safety_rating: 4, time_spent: 3, walkability_rating: 1, notes: "Fuck this was far away from Joyride.")
